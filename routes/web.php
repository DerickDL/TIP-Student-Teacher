...
/**CHANGE PASSWORD**/
Route::get('/change-password', 'App\frontUsers@changePasswordView')->middleware('check.session');
...
Route::get('/quizzes/graph/{teacher_id}', 'Quizzes\controllerQuizzesGraph@getQuizzesGraph');